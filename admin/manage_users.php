        ...
        <table class="min-w-full leading-normal">
            <thead class="bg-gray-200">
                <tr>
                    ...
                    <th class="px-5 py-3 border-b-2 border-gray-300 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider">Quiz Start</th>
                    <th class="px-5 py-3 border-b-2 border-gray-300 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider">Quiz End</th>
            ...
            <tbody>
                <?php if (empty($normal_users)): ?>
                    <tr><td colspan="7" class="text-center py-10 text-gray-500">No normal users found.</td></tr>
                <?php else: ?>
                    <?php foreach ($normal_users as $user): ?>
                        ...
                        <tr id="user-row-<?= $user['id'] ?>">
                            ...
                            <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                <?= $user['quiz_started_at'] ? date('M d, Y H:i', strtotime($user['quiz_started_at'])) : '—' ?>
                            </td>
                            <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                <?= $user['quiz_ended_at'] ? date('M d, Y H:i', strtotime($user['quiz_ended_at'])) : '—' ?>
                            </td>
                            <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
